  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8 py-6">
      <div className="text-center space-y-2">
        <span className="px-3 py-1 bg-[#E8A020]/15 text-[#E8A020] text-xs font-bold rounded-full uppercase tracking-wider">
          STEP 2 OF 3 — CHOOSE YOUR PATH
        </span>
        <h2 className="font-headline-lg text-3xl text-[#074B7D] font-bold">
          How Would You Like to Proceed for Plot #{plotNumber}?
        </h2>
        <p className="text-sm text-slate-500 max-w-lg mx-auto">
          {phaseName} • Cash Price: <span className="font-bold text-[#0B7FC7]">Ksh {cashPrice.toLocaleString()}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div
          ...
          className="relative bg-[#F0F4F8] border-2 border-[#0B7FC7] rounded-2xl p-6 shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all cursor-pointer flex flex-col justify-between space-y-6"
        >
          <span className="absolute -top-3 right-4 bg-[#E8A020] text-white text-[10px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">
            RECOMMENDED
          </span>

          <div className="space-y-4">
            <div className="w-12 h-12 rounded-xl bg-[#0B7FC7]/10 flex items-center justify-center text-[#0B7FC7]">
              <Lock size={24} />
            </div>
            <div>
              <h3 className="font-headline-md text-xl text-[#074B7D] font-bold">Reserve This Plot Now</h3>
          ...
          <div className="space-y-4 pt-4 border-t border-slate-200">
            <div>
              ...
              <p className="font-stat-lg text-2xl font-extrabold text-[#0B7FC7]">Ksh {reservationFee.toLocaleString()}</p>
              <p className="text-[10px] text-[#E8A020] font-semibold mt-0.5">Deducted from final deposit</p>
            </div>
            <button className="w-full py-3 bg-[#0B7FC7] text-white font-label-md text-xs font-bold rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
        ...
        >
          ...
          <div className="space-y-4 pt-4 border-t border-slate-100">
            ...
            <button className="w-full py-3 border border-[#074B7D] text-[#074B7D] font-label-md text-xs font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors">
