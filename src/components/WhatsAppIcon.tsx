/**
 * Gatepath Realtors — WhatsApp glyph (Phase 42)
 * Extracted from WhatsAppButton.tsx's inline SVG so the same brand-accurate
 * icon (not a generic lucide MessageCircle) can be reused anywhere a real
 * WhatsApp affordance is shown — e.g. the header TopBar.
 */
