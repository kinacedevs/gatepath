...
function DiasporaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F4EE] text-foreground font-sans">
      ...
      <section className="relative min-h-screen w-full flex flex-col justify-between pt-32 pb-16 bg-[#074B7D] overflow-hidden text-white">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#074B7D]/95 via-[#074B7D]/85 to-[#074B7D]/60" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 my-auto py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-serif font-bold text-5xl sm:text-6xl lg:text-7xl leading-[1.08] text-white">
              ...
              <span className="italic text-[#E8A020]">You don't have to be</span><br />
              <span className="italic text-[#E8A020]">there</span> to own it.
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#E8A020] hover:bg-[#C8861A] text-white font-bold text-sm rounded-xl transition-all shadow-xl"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#074B7D]/85 backdrop-blur-xl border border-white/20 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 text-white">
              {/* Nairobi Clock */}
              <div className="flex items-center justify-between pb-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  <Clock className="text-[#E8A020]" size={24} />
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-300 block">NAIROBI TIME</span>
                    <span className="font-stat-lg text-2xl font-extrabold text-[#E8A020]">{nairobiTime || "12:00 PM"}</span>
                  </div>
                </div>
                  ...
                  {(["KES", "USD", "GBP", "EUR"] as Currency[]).map((c) => (
                    <button
                      ...
                      className={`py-2 text-xs font-bold rounded-lg transition-all ${
                        currency === c
                          ? "bg-[#E8A020] text-[#074B7D] shadow-md font-extrabold"
              ...
              <div className="space-y-2.5 pt-2 text-xs border-t border-white/10">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-stat-lg font-bold text-[#E8A020]">{formatPrice(320000)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Beach Life (Malindi 1/4ac):</span>
                  <span className="font-stat-lg font-bold text-[#E8A020]">{formatPrice(160000)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Amani Gardens (Sagana):</span>
                  <span className="font-stat-lg font-bold text-[#E8A020]">{formatPrice(749000)}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-10 py-16 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="text-xs font-bold uppercase tracking-widest text-[#E8A020]">REMOTE PEACE OF MIND</span>
          <h2 className="font-serif font-bold text-3xl sm:text-4xl text-[#074B7D]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            <ShieldCheck className="text-[#0B7FC7]" size={32} />
            <h3 className="font-serif font-bold text-lg text-[#074B7D]">1. Verified Title Deeds</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            <FileCheck className="text-[#22C55E]" size={32} />
            <h3 className="font-serif font-bold text-lg text-[#074B7D]">2. Zero Double Allocation</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            <Download className="text-[#E8A020]" size={32} />
            <h3 className="font-serif font-bold text-lg text-[#074B7D]">3. Power of Attorney Guide</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="font-serif font-bold text-lg text-[#074B7D]">4. Global Card & Wire Rails</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
