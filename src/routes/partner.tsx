      ...
      <div className="pt-20">
        ...
        <section className="bg-primary text-white py-20 px-6 text-center">
          <div className="mx-auto max-w-4xl">
            <span className="inline-flex items-center gap-2 bg-accent/20 text-accent border border-accent/30 font-semibold tracking-wider uppercase text-[12px] px-3.5 py-1.5 rounded-full mb-4">
              <Handshake size={14} /> Partner Channel
            </span>
            <h1 className="font-serif font-bold text-[38px] md:text-[56px] leading-tight">
              Earn Commissions with <span className="text-accent">Gatepath</span>
            </h1>
        ...
        <section className="py-16 px-6 mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-xl border border-[#E5E0D8] shadow-sm text-center">
              <Award className="mx-auto text-primary mb-4" size={36} />
              <h3 className="font-serif font-semibold text-[18px] text-foreground mb-2">
            ...
            <div className="bg-white p-8 rounded-xl border border-[#E5E0D8] shadow-sm text-center">
              <Share2 className="mx-auto text-primary mb-4" size={36} />
              <h3 className="font-serif font-semibold text-[18px] text-foreground mb-2">
          ...
          <div className="mx-auto max-w-2xl bg-white rounded-2xl border border-[#E5E0D8] p-8 md:p-12 shadow-md">
            {success ? (
              <div className="text-center animate-in fade-in duration-300">
                <CheckCircle2 className="mx-auto text-available mb-6" size={64} />
                <h2 className="font-serif font-bold text-[28px] text-foreground mb-3">
                  Partner Registered!
                </h2>
                ...
                <div className="bg-ivory rounded-lg p-5 border border-[#E5E0D8] text-left">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      readOnly
                      value={referralLink}
                      className="bg-white border border-[#D5D0C8] rounded px-3 py-2 text-[13px] font-numbers font-medium w-full text-foreground outline-none"
                    />
                    <button
                      onClick={handleCopy}
                      className="bg-primary text-white px-4 py-2 rounded font-semibold text-sm hover:bg-[#09669E] shrink-0 flex items-center gap-1.5 transition-colors"
                    >
                      <Clipboard size={16} />
                      {copied ? "Copied" : "Copy"}
                    </button>
                ...
                <div className="mt-8 flex gap-4 justify-center">
                  <Link
                    to="/portal"
                    className="bg-primary text-white font-semibold text-[14px] px-8 py-3 rounded-lg hover:bg-[#09669E] transition-all shadow-sm"
                  >
                    Go to Client Portal
                  </Link>
                  <button
                    onClick={() => setSuccess(false)}
                    className="border border-[#D5D0C8] text-muted-foreground font-semibold text-[14px] px-6 py-3 rounded-lg hover:bg-ivory transition-all"
                  >
                    Register Another
                  </button>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-[#D5D0C8] rounded-lg p-3 text-sm outline-none focus:border-primary"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-[#D5D0C8] rounded-lg p-3 text-sm font-medium uppercase tracking-wider outline-none focus:border-primary"
                  />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-accent text-white font-bold text-base py-4 rounded-lg hover:bg-accent-dark transition-colors disabled:bg-gray-300"
                >
